...
if __name__ == "__main__":
    # Create a 10x10 grid with 20% obstacle probability
    generator = GridGenerator(grid_size=10, obstacle_prob=0.2)
    
    # Generate the grid
    grid = generator.generate()
    
    # Print the grid
    print("Generated Grid (■ = obstacle, □ = free):")
    print(generator)
    print(f"\nGrid size: {generator.grid_size}x{generator.grid_size}")
    print(f"Obstacle probability: {generator.obstacle_prob}")
